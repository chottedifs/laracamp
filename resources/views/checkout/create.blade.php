                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                @if ($errors->has('email'))
                                    <p class="text-danger mt-2 mb-2">{{ $errors->first('email') }}</p>
                                @endif
                            </div>
                            <div class="mb-4">
                                ...
                                @if ($errors->has('occupation'))
                                    <p class="text-danger mt-2 mb-2">{{ $errors->first('occupation') }}</p>
                                @endif
                            </div>
                            <div class="mb-4">
                                ...
                                @if ($errors->has('card_number'))
                                    <p class="text-danger mt-2 mb-2">{{ $errors->first('card_number') }}</p>
                                @endif
                            </div>
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        @if ($errors->has('expired'))
                                            <p class="text-danger mt-2 mb-2">{{ $errors->first('expired') }}</p>
                                        @endif
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        ...
                                        @if ($errors->has('cvc'))
                                            <p class="text-danger mt-2 mb-2">{{ $errors->first('cvc') }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
